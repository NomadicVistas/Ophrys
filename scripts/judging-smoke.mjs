...
try {
  ...
  console.log('boundaries: hourly counter-signal only; no request trace or liveness claim; Operator denied by default; publication curated; compute budget visible')
} finally {
  server.close()
