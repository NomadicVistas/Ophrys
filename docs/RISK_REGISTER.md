...
| A comparison or topology edge is mistaken for curatorial authority | High | Comparison remains browser-only state; approve/reject/revise require rationale; status, provenance and append-only decision node are committed atomically; public copy limits Operator attribution | OPH-018 tested |
