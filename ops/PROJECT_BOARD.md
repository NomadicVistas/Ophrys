...
| OPH-022 | P1 | ACTIVE | Phase-two reliability and judge pass | Reduced-motion/320px and transactional migration/malformed-relation failure handling are covered; stale-state, redaction and judge-reproducibility audits remain |
