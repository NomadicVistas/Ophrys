...
| OPH-022 | P1 | ACTIVE | Phase-two reliability and judge pass | Reduced-motion/320px, transactional migration/malformed-relation handling and stale-state timestamp integrity are covered; redaction and judge-reproducibility audits remain |
