...
| Ecosystem | Seed and generated artwork nodes, bounded runtime-field state, hourly counter-signal nodes, cycle/provenance packets, status transitions and explicit typed relations | OPH-017 connects expiring counter-pressure to the runtime field; curatorial decision and physical-output nodes remain to be connected |
